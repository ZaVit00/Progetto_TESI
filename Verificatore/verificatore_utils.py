...
# - Processo di ottenimento dei metadati delle anomalie dal cloud (disponibile per verificatore leggero)
# - Processo di ottenimento delle differenze (confronto dati cloud vs dati locale disponibile per verificatore esteso)
